...
interface SendPdfStudioLicenseEmailParams {
    to: string;
    customerName: string;
    licenseKey: string;
    expiryDate: Date;
...
<body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#f9fafb;margin:0;padding:40px 20px">
  <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:12px;border:1px solid #e5e7eb;overflow:hidden">
    ...
    <div style="background:#0b1e3f;padding:32px 40px">
      <h1 style="color:#fff;margin:0;font-size:22px;font-weight:700;letter-spacing:-0.5px">Aethelgard PDF Studio</h1>
    ...
    <div style="padding:40px">
      <p style="color:#111827;font-size:16px;margin:0 0 24px">Hi ${escapeHtml(customerName)},</p>
      <p style="color:#374151;font-size:15px;line-height:1.6;margin:0 0 24px">
        Thank you for purchasing <strong>Aethelgard PDF Studio</strong>. Your license key is below.
      </p>
      ...
      <h2 style="color:#111827;font-size:15px;font-weight:600;margin:0 0 12px">How to activate</h2>
      <ol style="color:#374151;font-size:14px;line-height:1.8;margin:0 0 24px;padding-left:20px">
        <li>Download Aethelgard PDF Studio for Windows: <a href="https://aethelgard.finance/pdf-studio" style="color:#c9a45a">aethelgard.finance/pdf-studio</a></li>
      ...
      <p style="color:#6b7280;font-size:13px;line-height:1.6;margin:0 0 12px">
        Already use Aethelgard? Your existing AETHG-… key activates PDF Studio for free. This standalone key is for using PDF Studio on its own.
      </p>
    ...
    <div style="background:#f9fafb;border-top:1px solid #f3f4f6;padding:20px 40px">
      <p style="color:#9ca3af;font-size:12px;margin:0">
        Aethelgard PDF Studio — local-first PDF editing for finance work.
      </p>
    </div>
